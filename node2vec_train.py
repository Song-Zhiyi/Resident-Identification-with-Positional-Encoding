...
@click.option("--walks", type=int, required=True, default=700, help="Number of random walks, default=700")
@click.option("--walk-length", type=int, required=True, default=1000, help="The length of each walk (sequence length) default=1000")
@click.option("--dimensions", type=int, required=True, default=256, help="The dimensions of the outcome embeddings default=256")
