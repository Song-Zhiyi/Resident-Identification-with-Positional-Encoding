...
def build_preset(exp_name: str, repeat: int=N_REPEATS):
    ...
    def in_time(data_name: str, start: datetime=pd.Timestamp.min, end: datetime=pd.Timestamp.max):
        ...
        return lib.exp_embeddings(
            ...
            data_name=data_name, n_epoch=lib.N_EPOCH, n_repeats=repeat, chunk_size=1000)

    return [
        in_time("twor2009-10d-01-chunk-1000", start=datetime(2009, 2, 2),
                end=datetime(2009, 2, 12)),
        in_time("twor2009-10d-02-chunk-1000", start=datetime(2009, 2, 12),
                end=datetime(2009, 2, 22)),
        in_time("twor2009-10d-03-chunk-1000", start=datetime(2009, 3, 1),
                end=datetime(2009, 3, 10)),
        in_time("twor2009-10d-04-chunk-1000", start=datetime(2009, 3, 10),
                end=datetime(2009, 3, 20)),
        in_time("twor2009-10d-05-chunk-1000", start=datetime(2009, 3, 20),
